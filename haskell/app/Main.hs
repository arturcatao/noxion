...
mostrarAjuda state = do
    putStrLn ""
    putStrLn "  ╔══════════════════════════════════════════════════════╗"
    putStrLn "  ║                 NOXION - Ajuda                       ║"
    putStrLn "  ╠══════════════════════════════════════════════════════╣"
    putStrLn "  ║  Noxion e um sistema de gerenciamento de tarefas     ║"
    putStrLn "  ║  via terminal, desenvolvido em Haskell.              ║"
    putStrLn "  ╠══════════════════════════════════════════════════════╣"
    putStrLn "  ║  CADASTRO                                            ║"
    putStrLn "  ║    1. Escolha [2] Cadastrar no menu inicial          ║"
    putStrLn "  ║    2. Digite um login unico                          ║"
    putStrLn "  ║    3. Digite seu nome                                ║"
    putStrLn "  ║    4. Digite uma senha                               ║"
    putStrLn "  ║    Apos o cadastro, voce sera logado automaticamente ║"
    putStrLn "  ╠══════════════════════════════════════════════════════╣"
    putStrLn "  ║  LOGIN                                               ║"
    putStrLn "  ║    1. Escolha [1] Login no menu inicial              ║"
    putStrLn "  ║    2. Digite seu login                               ║"
    putStrLn "  ║    3. Digite sua senha                               ║"
    putStrLn "  ║    Credenciais invalidas retornam ao menu            ║"
    putStrLn "  ╠══════════════════════════════════════════════════════╣"
    putStrLn "  ║  FUNCIONALIDADES                                     ║"
    putStrLn "  ║    - Criar tasks com titulo, descricao e prazo       ║"
    putStrLn "  ║    - Status: Nao Feito, Em Progresso, Feito          ║"
    putStrLn "  ║    - Prioridade: Low, Medium, High                   ║"
    putStrLn "  ║    - Filtros por status, prioridade e atraso         ║"
...
menuPrincipal state = do
    let nomeUser = maybe "" User.nome (currentUser state)
    putStrLn ""
    putStrLn " ╔══════════════════════════════════╗"
    putStrLn  " ║         NOXION - Tasks           ║"
    putStrLn (" ║         Ola, " ++ nomeUser ++ replicate (19 - length nomeUser) ' ' ++ " ║")
    putStrLn  " ╠══════════════════════════════════╣"
